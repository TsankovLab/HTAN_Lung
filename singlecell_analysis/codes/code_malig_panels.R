######################@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ 
######################@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ FIGURE 2+3 - EXTENDED DATA 2+3 - MALIGNANT PANELS
library(ggplot2)
library(Seurat)
...
###########
pdf(paste0(figures.dir, "Fig2A.pdf"), useDingbats = F, width = 10)
p = DimPlot(malig)
p
dev.off()
...
###########
pdf(paste0(figures.dir, "Fig2B.pdf"), useDingbats = F, width = 14, height = 5)
...
###########
pdf(paste0(figures.dir,"Fig2C.pdf"), width = 10, height = 9, useDingbats=F)
...
pdf(paste0(figures.dir, "Fig2E_left.pdf"), width = 3, height = 15, useDingbats=FALSE)
...
############ 
pdf(paste0(figures.dir, "Fig2G.pdf"), useDingbats = F, width = 8, height = 3)
...
# 
pdf(paste0(figures.dir, "Fig3F.pdf"), width = 22, height = 5, useDingbats=FALSE)
...
# 
pdf(paste0(figures.dir, "Fig3G_left.pdf"), width = 20, height = 5, useDingbats=FALSE) 
...
############# 
pdf(paste0(figures.dir, "Fig3G_right.pdf"), width = 5, height = 5, useDingbats=FALSE)
mean.plot
dev.off()
...
############ 
pdf(paste0(figures.dir, "Fig3H_left.pdf"), width = 4, height = 4)
...
############
pdf(paste0(figures.dir, "Fig3I.pdf"), width = 4, height = 4)
...
#############
pdf(paste0(figures.dir, "Fig3L.pdf"), width = 3, height = 4)
...
############ 
pdf(file = paste0(figures.dir, "Fig3M.pdf"), useDingbats = F, width = 2.3, height = 4)
...
############
pdf(paste0(figures.dir, "Fig3N.pdf"), width = 4.5, height = 4.5)  
...
pdf(paste0(figures.dir, "Ext_Fig2B.pdf"), useDingbats = F, width = 8, height = 10)
print(p)
dev.off()
...
pdf(paste0(figures.dir,"Ext_Fig2C.pdf"), width = 10, height = 9, useDingbats=F)
p<-Heatmap(res.ann, cluster_rows = F, cluster_columns = F)
p
dev.off()
...
############
pdf(paste0(figures.dir, "Ext_Fig2D.pdf"), width = 10, height = 8) 
...
#####################@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
##################### Extended Figure 2H
maligv9.scores.df <- get(load(paste0(data.path, "Ext_Fig2H_modulescore.Rda")))
...
# 
pdf(paste0(figures.dir, "Ext_Fig2H.pdf"), width = 12, height = 4, useDingbats=FALSE)
cowplot::plot_grid(plotlist = mean.plots.2, ncol=5)
dev.off()
...
pdf(paste0(figures.dir, "Ext_Fig2I.pdf"), width = 5, height = 3, useDingbats=FALSE)
...
###
pdf(paste0(figures.dir, "Ext_Fig3A.pdf"), width = 12, height = 5, useDingbats=FALSE)
...
############
pdf(paste0(figures.dir, "Ext_Fig3D.pdf"), width = 5, height = 5)  
ggviolin(ccat.df, x = "impact", y = "ccat.v", fill = "impact",
         palette = my_color_palette,
         add = "boxplot", add.params = list(fill = "white"))+
  rotate_x_text(angle = 45) + NoLegend() +
