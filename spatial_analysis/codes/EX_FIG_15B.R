...
pdf(file = paste0(figures.dir, "EX_FIG_15B_mean.pdf"), useDingbats = F, width = 6, height = 6)
...
pdf(file = paste0(figures.dir, "EX_FIG_15B_diff.pdf"), useDingbats = F, width = 6, height = 6)
