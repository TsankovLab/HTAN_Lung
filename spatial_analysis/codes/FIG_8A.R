...
pdf(file = paste0(figures.dir, "FIG_8A_mean.pdf"), useDingbats = F, width = 4, height = 3.5)
...
pdf(file = paste0(figures.dir, "FIG_8A_diff.pdf"), useDingbats = F, width = 4, height = 3.3)
