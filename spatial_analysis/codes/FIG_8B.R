...
# spatial boxplots
pdf(paste0(figures.dir, "FIG_8B_endo_mes.pdf"), width = 3, height = 3, useDingbats=FALSE)
...
# spatial boxplots
pdf(paste0(figures.dir, "FIG_8B_end_mye.pdf"), width = 3, height = 3, useDingbats=FALSE)
...
# spatial boxplots
pdf(paste0(figures.dir, "FIG_8B_end_cancer.pdf"), width = 3, height = 3, useDingbats=FALSE)
