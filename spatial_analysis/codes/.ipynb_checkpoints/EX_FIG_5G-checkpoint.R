proj.path <- "/sc/arion/projects/Tsankov_Normal_Lung/users/tp53_resubmission/"
data.path <- "/sc/arion/projects/Tsankov_Normal_Lung/users/tp53_resubmission/data/"
out.path <- "/sc/arion/projects/Tsankov_Normal_Lung/users/tp53_resubmission/all_output/"
figures.dir <- paste0(out.path, "figures/")
system(paste0("mkdir -p ", figures.dir))
source.input.dir <- paste0(out.path, "source_input/")
system(paste0("mkdir -p ", source.input.dir))
...
pdf(paste0(figures.dir, 'EX_FIG_5G_spatial.pdf'), useDingbats = F, width = 10, height = 10)
...
write.csv(df.t, paste0(source.input.dir, "EX_FIG_5G_ephb2_efnb1.csv"))

pdf(paste0(figures.dir, "EX_FIG_5G_ephb2_efnb1.pdf"), width = 3, height = 3, useDingbats=FALSE)
