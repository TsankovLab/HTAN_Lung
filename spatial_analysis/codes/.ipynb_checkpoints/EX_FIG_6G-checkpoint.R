...
pdf(paste0(figures.dir, 'EX_FIG_6G_spatial.pdf'), useDingbats = F, width = 10, height = 10)
...
pdf(paste0(figures.dir, "EX_FIG_6G_ephb2_efnb1.pdf"), width = 3, height = 3, useDingbats=FALSE)
